...
# Asking the questions in the game
def make_guess():
    counter = 0
    global guess_wrong
...
# Removes the _ when there is a space
...
# Removes the _ when there is a ' , then adds the ' into the puzzle
...
# The start - Asks for the game's word/puzzle
v = getpass.getpass("(ONLY USE: Letters, Spaces, and Apostraphes)\nEnter the phrase/word for the puzzle: ")
word = v.upper()
...
# Specifies the guesses allowed and the score
total_str = str(total)
...
# Adds in _ for letters of the word
for i in word:
    board.append("_")

# Calls for the special input conditions
make_space_guess()
make_special_guess()
